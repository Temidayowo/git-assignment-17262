...
const Hero = () => {
  return (
    <section className="flex flex-col justify-center items-center bg-[radial-gradient(ellipse_at_50%_0%,#22c55e22_0%,transparent_80%)] bg-[#0d0f14] w-full min-h-screen px-4 sm:px-8 md:px-16 lg:px-48 py-7 font-dm-sans">
      ...
      <div className="rounded-t-2xl max-w-5xl">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-6 mt-8">
          <button className="bg-[#22c55e] hover:bg-[#22c55e]/90 px-6 sm:px-8 rounded-full py-3 sm:py-5 text-sm sm:text-lg text-white transition-colors duration-300 border border-[#22c55e] font-dm-sans w-full sm:w-auto">
            See My Work
          </button>
          <button className="bg-transparent hover:bg-[#1a1b20] px-6 sm:px-8 rounded-full py-3 sm:py-5 text-sm sm:text-lg text-white transition-colors duration-300 border border-[#222633] font-dm-sans flex items-center justify-center gap-4 w-full sm:w-auto">
